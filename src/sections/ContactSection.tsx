      ...
      <div className="container-custom">
        ...
        <div className="relative">
          <div className="absolute inset-0 -z-10">
            <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(600px,90vw)] h-[min(400px,60vw)] bg-indigo-600/6 blur-[80px] rounded-full" />
          </div>
