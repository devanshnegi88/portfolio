  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/4 left-1/4 w-[min(600px,80vw)] h-[min(600px,80vw)] rounded-full bg-cyan-600/5 blur-[120px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-[min(500px,70vw)] h-[min(500px,70vw)] rounded-full bg-blue-600/5 blur-[100px] animate-pulse" style={{ animationDelay: '2s' }} />
        <div
