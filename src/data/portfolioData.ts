...
export const personal: PersonalInfo = {
  ...
  resume: '/Devansh_Resume.docx',
  profileImage: '/profile.jpeg',
};

export const siteMeta: SiteMeta = {
  title: 'Devansh Negi — Backend and AI Engineer',
  description:
    'Backend and AI Engineer specializing in scalable APIs, AI-powered applications, and cloud-native systems. Based in India.',
...
export const navLinks: NavLink[] = [
  ...
  { label: 'Building', href: '#actively-building' },
...
export const hero: Hero = {
  ...
  cta: [
    ...
    { label: 'Download Resume', href: '/Devansh_Resume.docx', variant: 'secondary' },
...
export const skills: SkillCategory[] = [
  {
    name: 'Backend',
    color: 'indigo',
    skills: ['Python', 'FastAPI', 'Node.js','flask','Express', 'REST APIs', 'GraphQL', 'JWT/OAuth','WebSockets', 'Microservices'],
  },
  {
    name: 'AI/ML',
    color: 'violet',
    skills: ['LLMs', 'Agentic RAG', 'LangChain', 'LangGraph', 'OpenAI', 'Gemini', 'Scikit-learn','Transformers','TensorFlow','PyTorch','Computer Vision'],
  },
  {
    name: 'Databases',
    color: 'cyan',
    skills: ['PostgreSQL', 'MongoDB','SQL Server','MySQL', 'Redis', 'FAISS', 'Vector DBs', 'Supabase'],
  },
  {
    name: 'Cloud & DevOps',
    color: 'emerald',
    skills: ['Docker', 'AWS', 'Linux', 'CI/CD', 'GitHub Actions', 'Vercel', 'Render','GCP'],
  },
  {
    name: 'Frontend',
    color: 'indigo',
...
export const experience: Experience[] = [

  {
    ...
    current: false,
    achievements: [
     'Developed and tested backend APIs using NestJS and TypeORM.',
      'Worked with PostgreSQL for database design, queries, and data management.',
      'Used Redis for caching and backend data handling.',
      'Worked with React for frontend development and UI improvements.',
      'Used Docker for application development and local environments.',
      'Used Jira for task management, bug tracking, and collaboration.',
      'Performed functional testing, API testing, debugging, and issue verification.',
    ],
    tech: ['Node.Js', 'NestJs', 'PostgreSQL','React', 'JWT', 'Redis', 'Docker'],
  },
  {
